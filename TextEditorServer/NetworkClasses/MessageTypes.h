...
enum BodyType{
    cursor_position, delete_document_res, delete_document_req, document_info, document_info_req, collaboration_req, collaboration_res, subscribe_req, subscribe_res, unsubscribe_req, actions, summary_req, summary_res, new_document_req, new_document_res, documents_req, documents_res, document_req, document_res, login_req, login_res, signup_req, signup_res, logout_req, logout_res,closedoc_res, nop
};
...
static BodyType qStringToBodyType(const QString &qString) {
    if(qString=="actions") {
        ...
        return BodyType::nop;
    }else if(qString=="subscribe_res"){
        return BodyType::subscribe_res;
    }
